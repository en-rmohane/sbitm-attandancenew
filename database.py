...
def seed_initial_data(conn):
    ...
    subjects_seed = [
        ...
        # --- AI-DS III SEM (2nd Year AI-DS) ---
        ("AD-301", "Technical Communication (Tech Comm)", "Theory", "2nd Year (AI-DS)", "AI-DS", "III", ["rishu"]),
        ("AD-302", "Probability & Statistics (Prob & Stat)", "Theory", "2nd Year (AI-DS)", "AI-DS", "III", ["malvi"]),
        ("AD-303", "Data Structures (AD)", "Theory", "2nd Year (AI-DS)", "AI-DS", "III", ["pankaj"]),
        ("AD-303", "Data Structures Lab (AD)", "Practical", "2nd Year (AI-DS)", "AI-DS", "III", ["ravi"]),
        ("AD-304", "Artificial Intelligence (AI)", "Theory", "2nd Year (AI-DS)", "AI-DS", "III", ["shashank"]),
        ("AD-304", "AI Lab", "Practical", "2nd Year (AI-DS)", "AI-DS", "III", ["shashank"]),
        ("AD-305", "OOPM (AI-DS)", "Theory", "2nd Year (AI-DS)", "AI-DS", "III", ["ravi"]),
        ("AD-305", "OOPM Lab (AI-DS)", "Practical", "2nd Year (AI-DS)", "AI-DS", "III", ["ravi"]),
        ("AD-306", "Introduction To Python Lab", "Practical", "2nd Year (AI-DS)", "AI-DS", "III", ["deepika"]),
        ("BT-107", "Internship-I (AI-DS)", "Practical", "2nd Year (AI-DS)", "AI-DS", "III", ["vinay"]),

        # --- AI-DS V SEM (3rd Year AI-DS) ---
        ("AD-501", "Theory of Computation (TOC AD)", "Theory", "3rd Year (AI-DS)", "AI-DS", "V", ["satish"]),
        ("AD-501", "TOC Lab (AI-DS)", "Practical", "3rd Year (AI-DS)", "AI-DS", "V", ["satish"]),
        ("AD-502", "Machine Learning (ML)", "Theory", "3rd Year (AI-DS)", "AI-DS", "V", ["ashish"]),
        ("AD-502", "ML Lab", "Practical", "3rd Year (AI-DS)", "AI-DS", "V", ["ashish"]),
        ("AD-503", "Computer Organization & Architecture (COA)", "Theory", "3rd Year (AI-DS)", "AI-DS", "V", ["bhavesh"]),
        ("AD-504", "Management Information Systems (MIS)", "Theory", "3rd Year (AI-DS)", "AI-DS", "V", ["nilesh"]),
        ("AD-505", "COA Lab", "Practical", "3rd Year (AI-DS)", "AI-DS", "V", ["bhavesh"]),
        ("AD-506", "Linux Lab (AI-DS)", "Practical", "3rd Year (AI-DS)", "AI-DS", "V", ["khushbu"]),
        ("BT-407", "Internship-II (AI-DS)", "Practical", "3rd Year (AI-DS)", "AI-DS", "V", ["vinay"]),
        ("AD-508", "Minor Project (AI-DS)", "Practical", "3rd Year (AI-DS)", "AI-DS", "V", ["nilesh"]),
    ...
    if cursor.fetchone()['count'] == 0:
        students_data = [
            ...
            # 2nd Year (3rd Sem AI-DS - 49 Students Official List)
            ...
            # 3rd Year (5th Sem AI-DS - 28 Students Official List)
            ...
            # 4th Year (7th Sem AI-DS - 18 Students Official List)
